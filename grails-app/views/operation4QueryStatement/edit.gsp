        ...
        <g:form controller="operation4QueryStatement" action="update" id="${this.queryStatement.id}" method="PUT">
            ...
            <fieldset class="form">
                ...
                <table>
                    <tr>
                        <td>关键字</td>
                        <td><g:textField name="keyString" value="${queryStatement.keyString}"
                                         style="width: 50em"></g:textField></td>
                    </tr>
                    <tr>
                        <td>查询语句</td>
                    ...
                    <tr>
                        <td>参数</td>
                        <td><g:textField name="paramsList" value="${queryStatement.paramsList}"
                                         style="width: 80em"></g:textField></td>
                    </tr>
                    <tr>
                        <td>视图</td>
