...
<body>
<a href="#edit-progress" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-progress" class="content scaffold-edit" role="main">
    ...
    <g:uploadForm id="${this.progress.id}" action="update" controller="${params.controller}" method="PUT">
        ...
        <fieldset class="form">
            ...
            <div class="fieldcontain ${hasErrors(bean: this.progress, field: 'contributor', 'error')} required">
                ...
                <g:select id="contributor" name="contributor.id" from="${cn.edu.cup.basic.Person.list()}" optionKey="id"
